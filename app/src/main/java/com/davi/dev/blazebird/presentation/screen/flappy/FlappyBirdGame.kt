...
private const val OBSTACLE_WIDTH = 20f
private const val MAX_OBSTACLE_HEIGHT = 120
private const val MIN_OBSTACLE_HEIGHT = 60

class FlappyBirdGame(
    private val birdSize: Float = 20f,
    private val birdJumpingVelocity: Float = 1.5f,
    ...
    private fun initGameValues() {
        ...
        this.obstacles = (0..20).map {
            ...
            val centerX = boundsWidth + OBSTACLE_WIDTH + OBSTACLE_WIDTH * 3.0f * it
    ...
    private fun moveBird() {
        ...
        val movement = -2f * time * time + birdJumpingVelocity * time
    ...
    private fun moveObstacles() {
        ...
        obstacles.forEach {
            ...
            if (isOutside) {
                it.centerX = lastX + OBSTACLE_WIDTH * 3.0f
            }
        }
    }
