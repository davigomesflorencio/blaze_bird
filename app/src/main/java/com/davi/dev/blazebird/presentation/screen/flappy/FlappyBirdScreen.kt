...
private val obstacleGreenNormal = Color(0xFF0ABAB5)
private val obstacleGreenDark = Color(0xFF56DFCF)
private val obstacleGreenLight = Color(0xFFADEED9)
private val obstacleGreenExtraLight = Color(0xFFFFEDF3)
...
private fun Bird(state: FlappyGameUi, modifier: Modifier) {
    ...
    Image(
        painter = painterResource(id = R.drawable.bird_f),
...
@Preview(
    device = SMALL_ROUND, showBackground = true, showSystemUi = true
)
@Composable
fun GamePreview() {
    FlappyBirdTheme {
